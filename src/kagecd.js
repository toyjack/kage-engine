...
import { divide_curve, calculateBezier, find_offcurve, get_candidate } from './curve.js';

export function cdDrawCurveU(kage, polygons, x1, y1, sx1, sy1, sx2, sy2, x2, y2, ta1, ta2){
  var rad, t;
  var x, y, v;
  var bezier, ia, ib;
  var tt;
