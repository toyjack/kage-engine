...
export function getCrossPoint(x11, y11, x12, y12, x21, y21, x22, y22){ // point
  var a1 = y12 - y11;
  var b1 = x11 - x12;
...
export function isCross(x11, y11, x12, y12, x21, y21, x22, y22){ // boolean
...
export function isCrossBox(x1, y1, x2, y2, bx1, by1, bx2, by2){ // boolean
